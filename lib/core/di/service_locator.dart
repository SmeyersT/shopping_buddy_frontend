...
Future<void> setupLocator() async {
  ...
  serviceLocator.registerSingleton<AuthenticationService>(AuthenticationService.create());
  serviceLocator.registerSingleton<GoogleHelper>(GoogleHelper());
  serviceLocator.registerSingleton<JWTHelper>(JWTHelper());
